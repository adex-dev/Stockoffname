  ...
  <div class="col-12">
    <div class="card">
      <div class="card-header ">
        ...
        <div class="d-flex justify-content-between">
          <div>
           <form class="row g-3">
              <div class="col-auto">
                 <button type="button" class="btn btn-success mb-3 btndownloadlaporan d-flex align-items-center" data-names="laporandiff"><i class='bx bx-download mx-2 text-white'></i> Download</button>
              </div>
            </form>
          </div>
          <div>
      ...
      <div class="card-body" style="height: 60vh;overflow-y: scroll;">
        <div class="row">
          <div class="col-12">
            <table class="table table-striped tableauditdiff table-hover table-bordered">
              <thead>
                <tr>
                  <th>Ean</th>
