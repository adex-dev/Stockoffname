<div class="row">
  <div class="col-12">
    <h1 class="text-center mt-2 bg-light rounded description">Laporan Audit</h1>
  </div>
  <div class="col-12">
    <div class="card">
      <div class="card-header">
        <div class="d-flex justify-content-between">
          <form class="row g-3">
              <div class="col-auto">
                 <button type="button" class="btn btn-success mb-3 btndownloadlaporan d-flex align-items-center" data-names="laporanaudit"><i class='bx bx-download mx-2 text-white'></i> Download</button>
              </div>
            </form>
            <div>
      ...
      <div class="card-body" style="height: 60vh;overflow-y: scroll;">
        <div class="row">
          <div class="col-12">
            <table class="table table-striped table-hover tablelaporanaudit table-bordered">
              <thead>
                <tr>
                  <th>Ean</th>
